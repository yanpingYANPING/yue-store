...
module.exports={
    ...
    cart_select:(req,res)=>{
        ...
        pool.getConnection((err,conn)=>{
            conn.query("SELECT yue_cart.ctid,yue_cart.did,yue_cart.dishCount,yue_product.name,yue_product.detail,yue_product.checkState,yue_product.price,yue_product.img_sm FROM yue_product,yue_cart WHERE yue_cart.did=yue_product.did AND yue_cart.userid=?",[uid],(err,result)=>{
                res.json(result);
                conn.release();
            })
        })
    ...
    order_detail:(req,res)=>{
        var uid=req.body.uid;
        pool.getConnection((err,conn)=>{
            conn.query("SELECT yue_order.oid,yue_order.price,yue_order.dishCount,yue_product.img_sm,yue_product.name,yue_product.detail FROM yue_order,yue_product WHERE yue_order.did=yue_product.did AND yue_order.uid=?",[uid],(err,result)=>{
                res.json(result);
                conn.release();
            })
        })
